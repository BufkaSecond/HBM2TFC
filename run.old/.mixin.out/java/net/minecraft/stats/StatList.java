...
public class StatList {
    ...
    public static StatBase func_151182_a(EntityEggInfo p_151182_0_) {
        String s = modifyExpressionValue$zhe000$hodgepodge$getEntityName(EntityList.getStringFromID(p_151182_0_.spawnedID), p_151182_0_);
    ...
    public static StatBase func_151176_b(EntityEggInfo p_151176_0_) {
        String s = modifyExpressionValue$zhe000$hodgepodge$getEntityName(EntityList.getStringFromID(p_151176_0_.spawnedID), p_151176_0_);
    ...
    static {
        ...
        field_151185_q = (new StatBasic("stat.horseOneCm", new ChatComponentTranslation("stat.horseOneCm", new Object[0]), StatBase.distanceStatType)).initIndependentStat().registerStat();
        ...
        field_151186_x = (new StatBasic("stat.animalsBred", new ChatComponentTranslation("stat.animalsBred", new Object[0]))).registerStat();
        ...
        field_151183_A = (new StatBasic("stat.junkFished", new ChatComponentTranslation("stat.junkFished", new Object[0]))).registerStat();
        field_151184_B = (new StatBasic("stat.treasureFished", new ChatComponentTranslation("stat.treasureFished", new Object[0]))).registerStat();
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinStatList",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private static String modifyExpressionValue$zhe000$hodgepodge$getEntityName(String original, EntityEggInfo info) {
        return info instanceof EntityInfo ? StatHandler.currentEntityName : original;
    }
}
