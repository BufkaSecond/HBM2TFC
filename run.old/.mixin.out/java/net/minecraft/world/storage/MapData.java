...
public class MapData extends WorldSavedData implements SafeWriteNBT {
    public int xCenter;
    public int zCenter;
    ...
    public void updateVisiblePlayers(EntityPlayer p_76191_1_, ItemStack p_76191_2_) {
        if (!this.playersHashMap.containsKey(p_76191_1_)) {
            net.minecraft.world.storage.MapData.MapInfo mapinfo = new net.minecraft.world.storage.MapData.MapInfo(this, p_76191_1_);
        ...
        for(int i = 0; i < this.playersArrayList.size(); ++i) {
            net.minecraft.world.storage.MapData.MapInfo mapinfo1 = (net.minecraft.world.storage.MapData.MapInfo)this.playersArrayList.get(i);
            ...
            } else if (!p_76191_2_.isOnItemFrame() && mapinfo1.entityplayerObj.dimension == this.dimension) {
    ...
    private void func_82567_a(int p_82567_1_, World p_82567_2_, String p_82567_3_, double p_82567_4_, double p_82567_6_, double p_82567_8_) {
        ...
        this.playersVisibleOnMap.put(p_82567_3_, new net.minecraft.world.storage.MapData.MapCoord(this, (byte)p_82567_1_, b0, b1, b2));
    }

    public byte[] getUpdatePacketData(ItemStack p_76193_1_, World p_76193_2_, EntityPlayer p_76193_3_) {
        net.minecraft.world.storage.MapData.MapInfo mapinfo = (net.minecraft.world.storage.MapData.MapInfo)this.playersHashMap.get(p_76193_3_);
    ...
    public void setColumnDirty(int p_76194_1_, int p_76194_2_, int p_76194_3_) {
        ...
        for(int l = 0; l < this.playersArrayList.size(); ++l) {
            net.minecraft.world.storage.MapData.MapInfo mapinfo = (net.minecraft.world.storage.MapData.MapInfo)this.playersArrayList.get(l);
    ...
    public void updateMPMapData(byte[] p_76192_1_) {
        ...
        if (p_76192_1_[0] == 0) {
            ...
            for(i = 0; i < (p_76192_1_.length - 1) / 3; ++i) {
                ...
                this.playersVisibleOnMap.put("icon-" + i, new net.minecraft.world.storage.MapData.MapCoord(this, b2, b3, b0, b1));
            }
    ...
    public net.minecraft.world.storage.MapData.MapInfo func_82568_a(EntityPlayer p_82568_1_) {
        net.minecraft.world.storage.MapData.MapInfo mapinfo = (net.minecraft.world.storage.MapData.MapInfo)this.playersHashMap.get(p_82568_1_);
        if (mapinfo == null) {
            mapinfo = new net.minecraft.world.storage.MapData.MapInfo(this, p_82568_1_);
