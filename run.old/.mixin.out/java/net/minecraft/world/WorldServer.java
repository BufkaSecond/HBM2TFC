...
public class WorldServer extends World implements ISimulationDistanceWorld {
    ...
    private net.minecraft.world.WorldServer.ServerBlockEventList[] field_147490_S = new net.minecraft.world.WorldServer.ServerBlockEventList[]{new net.minecraft.world.WorldServer.ServerBlockEventList((Object)null), new net.minecraft.world.WorldServer.ServerBlockEventList((Object)null)};
    ...
    @Unique
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldServer_LimitUpdateRecursion",
        priority = 1000,
    ...
    @Unique
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldServer_SimulationDistance",
        priority = 1001,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    ...
    public WorldServer(MinecraftServer p_i45284_1_, ISaveHandler p_i45284_2_, String p_i45284_3_, int p_i45284_4_, WorldSettings p_i45284_5_, Profiler p_i45284_6_) {
        ...
        if (this.entityIdMap == null) {
            this.entityIdMap = new FastUtilIntHashMap();
        }
        ...
        this.handler$zbb000$hodgepodge$initSimulationHelper(p_i45284_1_, p_i45284_2_, p_i45284_3_, p_i45284_4_, p_i45284_5_, p_i45284_6_, (CallbackInfo)null);
    }
    ...
    public void tick() {
        ...
        Iterator var2 = this.customTeleporters.iterator();

        while(var2.hasNext()) {
            Teleporter tele = (Teleporter)var2.next();
    ...
    protected void func_147456_g() {
        ...
        int i = 0;
        int j = 0;
        Chunk injectorAllocatedLocal20 = this.activeChunkSet;
        Iterator iterator = this.redirect$zzp001$hodgepodge$fixAllocations(injectorAllocatedLocal20);

        while(iterator.hasNext()) {
            ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)this.wrapOperation$zbb000$hodgepodge$chunkTicks(iterator, (var0) -> {
                WrapOperationRuntime.checkArgumentCount(var0, 1, "[java.util.Iterator]");
                return ((Iterator)var0[0]).next();
            });
            ...
            Chunk injectorAllocatedLocal20 = this.provider;
            int i1;
            int j1;
            int k1;
            int l1;
            if (this.wrapOperation$zbb000$hodgepodge$canDoLighting(injectorAllocatedLocal20, chunk, (var0) -> {
                WrapOperationRuntime.checkArgumentCount(var0, 2, "[net.minecraft.world.WorldProvider, net.minecraft.world.chunk.Chunk]");
                return ((WorldProvider)var0[0]).canDoLightning((Chunk)var0[1]);
            }) && this.rand.nextInt(100000) == 0 && this.isRaining() && this.isThundering()) {
            ...
            injectorAllocatedLocal20 = this.provider;
            if (this.wrapOperation$zbb000$hodgepodge$canDoRainSnowIce(injectorAllocatedLocal20, chunk, (var0) -> {
                WrapOperationRuntime.checkArgumentCount(var0, 2, "[net.minecraft.world.WorldProvider, net.minecraft.world.chunk.Chunk]");
                return ((WorldProvider)var0[0]).canDoRainSnowIce((Chunk)var0[1]);
            ...
            this.theProfiler.endStartSection("tickBlocks");
            ExtendedBlockStorage[] aextendedblockstorage = this.wrapOperation$zbb000$hodgepodge$randomTicks(chunk, (var0) -> {
                WrapOperationRuntime.checkArgumentCount(var0, 1, "[net.minecraft.world.chunk.Chunk]");
                return ((Chunk)var0[0]).getBlockStorageArray();
            });
    ...
    public void scheduleBlockUpdateWithPriority(int p_147454_1_, int p_147454_2_, int p_147454_3_, Block p_147454_4_, int p_147454_5_, int p_147454_6_) {
        CallbackInfo callbackInfo10 = new CallbackInfo("scheduleBlockUpdateWithPriority", true);
        this.handler$zhk000$hodgepodge$incrementBlockUpdateRecursionCounter(p_147454_1_, p_147454_2_, p_147454_3_, p_147454_4_, p_147454_5_, p_147454_6_, callbackInfo10);
        if (!callbackInfo10.isCancelled()) {
            ...
            if (this.scheduledUpdatesAreImmediate && p_147454_4_.getMaterial() != Material.air) {
                if (p_147454_4_.func_149698_L()) {
                    ...
                    this.handler$zhk000$hodgepodge$decrementBlockUpdateRecursionCounter(p_147454_1_, p_147454_2_, p_147454_3_, p_147454_4_, p_147454_5_, p_147454_6_, (CallbackInfo)null);
                    return;
                }
            ...
            if (this.checkChunksExist(p_147454_1_ - b0, p_147454_2_ - b0, p_147454_3_ - b0, p_147454_1_ + b0, p_147454_2_ + b0, p_147454_3_ + b0)) {
                ...
                if (!this.pendingTickListEntriesHashSet.contains(nextticklistentry)) {
                    ...
                    TreeSet injectorAllocatedLocal11 = this.pendingTickListEntriesTreeSet;
                    this.wrapOperation$zbb000$hodgepodge$addTick1(injectorAllocatedLocal11, nextticklistentry, (var0) -> {
                        WrapOperationRuntime.checkArgumentCount(var0, 2, "[java.util.TreeSet, java.lang.Object]");
                        return ((TreeSet)var0[0]).add((Object)var0[1]);
                    });
                }
            }
    ...
    public void func_147446_b(int p_147446_1_, int p_147446_2_, int p_147446_3_, Block p_147446_4_, int p_147446_5_, int p_147446_6_) {
        ...
        if (!this.pendingTickListEntriesHashSet.contains(nextticklistentry)) {
            this.pendingTickListEntriesHashSet.add(nextticklistentry);
            TreeSet injectorAllocatedLocal8 = this.pendingTickListEntriesTreeSet;
            this.wrapOperation$zbb000$hodgepodge$addTick2(injectorAllocatedLocal8, nextticklistentry, (var0) -> {
                WrapOperationRuntime.checkArgumentCount(var0, 2, "[java.util.TreeSet, java.lang.Object]");
                return ((TreeSet)var0[0]).add((Object)var0[1]);
            });
        }
    ...
    public void updateEntities() {
        if (this.playerEntities.isEmpty() && this.getPersistentChunks().isEmpty()) {
            if (this.updateEntityTick++ >= 1200) {
                this.handler$zeg000$hodgepodge$updateEntities((CallbackInfo)null);
                return;
            }
        } else {
    ...
    public boolean tickUpdates(boolean p_72955_1_) {
        Set injectorAllocatedLocal12 = this.pendingTickListEntriesTreeSet;
        int i = this.redirect$zbb000$hodgepodge$fakeTreeSetSize(injectorAllocatedLocal12);
        Set injectorAllocatedLocal12 = this.pendingTickListEntriesHashSet;
        if (i != this.redirect$zbb000$hodgepodge$fakeHashSetSize(injectorAllocatedLocal12)) {
            ...
            this.handler$zbb000$hodgepodge$tickUpdates(p_72955_1_, (CallbackInfoReturnable)null);
                ...
                if (this.checkChunksExist(nextticklistentry.xCoord - b0, nextticklistentry.yCoord - b0, nextticklistentry.zCoord - b0, nextticklistentry.xCoord + b0, nextticklistentry.yCoord + b0, nextticklistentry.zCoord + b0)) {
                    ...
                    if (block.getMaterial() != Material.air && Block.isEqualTo(block, nextticklistentry.func_151351_a())) {
                        try {
                            ...
                            CrashReport crashreport = CrashReport.makeCrashReport(var14, "Exception while ticking a block");
    ...
    public List func_147486_a(int p_147486_1_, int p_147486_2_, int p_147486_3_, int p_147486_4_, int p_147486_5_, int p_147486_6_) {
        ...
        for(int x = p_147486_1_ >> 4; x <= p_147486_4_ >> 4; ++x) {
            for(int z = p_147486_3_ >> 4; z <= p_147486_6_ >> 4; ++z) {
                ...
                if (chunk != null) {
                    Iterator var11 = chunk.chunkTileEntityMap.values().iterator();

                    while(var11.hasNext()) {
                        Object obj = var11.next();
                        TileEntity entity = (TileEntity)obj;
                        if (!entity.isInvalid() && entity.xCoord >= p_147486_1_ && entity.yCoord >= p_147486_2_ && entity.zCoord >= p_147486_3_ && entity.xCoord <= p_147486_4_ && entity.yCoord <= p_147486_5_ && entity.zCoord <= p_147486_6_) {
    ...
    protected void createBonusChest() {
        WorldGeneratorBonusChest worldgeneratorbonuschest = new WorldGeneratorBonusChest(ChestGenHooks.getItems("bonusChest", this.rand), ChestGenHooks.getCount("bonusChest", this.rand));
    ...
    public File getChunkSaveLocation() {
        return ((AnvilChunkLoader)this.theChunkProviderServer.currentChunkLoader).chunkSaveLocation;
    }
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldServer_FixAllocations",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private Iterator<ChunkCoordIntPair> redirect$zzp001$hodgepodge$fixAllocations(Set<ChunkCoordIntPair> instance) {
        return ((LongChunkCoordIntPairSet)instance).unsafeIterator();
    }

    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldServerUpdateEntities",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private void handler$zeg000$hodgepodge$updateEntities(CallbackInfo ci) {
    ...
    private void handler$zhk000$hodgepodge$incrementBlockUpdateRecursionCounter(int x, int y, int z, Block block, int tickDelay, int priority, CallbackInfo ci) {
        if (this.hodgepodge$currentBlockUpdateRecursiveCalls >= FixesConfig.limitRecursiveBlockUpdateDepth) {
            StackOverflowError error = new StackOverflowError(String.format("Too many recursive block updates (%d) at world %d, block %s (%d, %d, %d) - aborting further block updates", this.hodgepodge$currentBlockUpdateRecursiveCalls, this.provider.dimensionId, block, x, y, z));
    ...
    private void handler$zhk000$hodgepodge$decrementBlockUpdateRecursionCounter(int x, int y, int z, Block block, int tickDelay, int priority, CallbackInfo ci) {
    ...
    private void handler$zbb000$hodgepodge$initSimulationHelper(MinecraftServer p_i45284_1_, ISaveHandler p_i45284_2_, String p_i45284_3_, int p_i45284_4_, WorldSettings p_i45284_5_, Profiler p_i45284_6_, CallbackInfo ci) {
        SimulationDistanceHelper helper = this.hodgepodge$getSimulationDistanceHelper();
        helper.setServerVariables(this.pendingTickListEntriesTreeSet, this.pendingTickListEntriesHashSet, (x$0, x$1) -> {
            return this.chunkExists(x$0, x$1);
        });
    }
    ...
    private int redirect$zbb000$hodgepodge$fakeTreeSetSize(TreeSet<NextTickListEntry> instance) {
        return 0;
    }
    ...
    private int redirect$zbb000$hodgepodge$fakeHashSetSize(Set<NextTickListEntry> instance) {
        return 0;
    }
    ...
    private void handler$zbb000$hodgepodge$tickUpdates(boolean p_72955_1_, CallbackInfoReturnable<Boolean> cir) {
        SimulationDistanceHelper helper = this.hodgepodge$getSimulationDistanceHelper();
    ...
    private Object wrapOperation$zbb000$hodgepodge$chunkTicks(Iterator<ChunkCoordIntPair> instance, Operation<ChunkCoordIntPair> original) {
        SimulationDistanceHelper helper = this.hodgepodge$getSimulationDistanceHelper();
        ChunkCoordIntPair result = (ChunkCoordIntPair)original.call(new Object[]{instance});
        this.hodgepodge$processCurrentChunk = helper.shouldProcessTick(result.chunkXPos, result.chunkZPos);
        return result;
    }
    ...
    private boolean wrapOperation$zbb000$hodgepodge$canDoLighting(WorldProvider instance, Chunk chunk, Operation<Boolean> original) {
        return this.hodgepodge$processCurrentChunk ? (Boolean)original.call(new Object[]{instance, chunk}) : false;
    }
    ...
    private boolean wrapOperation$zbb000$hodgepodge$canDoRainSnowIce(WorldProvider instance, Chunk chunk, Operation<Boolean> original) {
        return this.hodgepodge$processCurrentChunk ? (Boolean)original.call(new Object[]{instance, chunk}) : false;
    }
    ...
    private ExtendedBlockStorage[] wrapOperation$zbb000$hodgepodge$randomTicks(Chunk instance, Operation<ExtendedBlockStorage[]> original) {
        return this.hodgepodge$processCurrentChunk ? (ExtendedBlockStorage[])original.call(new Object[]{instance}) : this.hodgepodge$emptyBlockStorage;
    }
    ...
    private boolean wrapOperation$zbb000$hodgepodge$addTick1(TreeSet<NextTickListEntry> instance, Object e, Operation<Boolean> original) {
        SimulationDistanceHelper helper = this.hodgepodge$getSimulationDistanceHelper();
    ...
    private boolean wrapOperation$zbb000$hodgepodge$addTick2(TreeSet<NextTickListEntry> instance, Object e, Operation<Boolean> original) {
        SimulationDistanceHelper helper = this.hodgepodge$getSimulationDistanceHelper();
        helper.addTick((NextTickListEntry)e);
        return (Boolean)original.call(new Object[]{instance, e});
    }
