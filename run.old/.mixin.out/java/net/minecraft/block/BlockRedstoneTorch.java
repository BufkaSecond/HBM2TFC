...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_, boolean p_150111_5_) {
        ...
        if (p_150111_5_) {
            list.add(new net.minecraft.block.BlockRedstoneTorch.Toggle(p_150111_2_, p_150111_3_, p_150111_4_, p_150111_1_.getTotalWorldTime()));
        }

        int l = 0;

        for(int i1 = 0; i1 < list.size(); ++i1) {
            net.minecraft.block.BlockRedstoneTorch.Toggle toggle = (net.minecraft.block.BlockRedstoneTorch.Toggle)list.get(i1);
    ...
    public void updateTick(World worldIn, int x, int y, int z, Random random) {
        ...
        while(list != null && !list.isEmpty() && worldIn.getTotalWorldTime() - ((net.minecraft.block.BlockRedstoneTorch.Toggle)list.get(0)).field_150844_d > 60L) {
            list.remove(0);
        }
    ...
    static {
        field_150112_b = new WeakHashMap();
    }
}
