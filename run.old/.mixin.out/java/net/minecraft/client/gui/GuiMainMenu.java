...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.handler$zbl000$hodgepodge$disableRealmsButton(p_73969_1_, p_73969_2_, (CallbackInfo)null);
    }
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinGuiMainMenu_DisableRealmsButton",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private void handler$zbl000$hodgepodge$disableRealmsButton(int p_73969_1_, int p_73969_2_, CallbackInfo ci) {
