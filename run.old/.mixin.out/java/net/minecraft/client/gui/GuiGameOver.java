...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        this.handler$zdh000$hodgepodge$resetedInitGui((CallbackInfo)null);
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinGuiGameOver",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    public void handler$zdh000$hodgepodge$resetedInitGui(CallbackInfo ci) {
