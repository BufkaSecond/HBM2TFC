...
public class WorldClient extends World {
    ...
    private IntHashMap entityHashSet = new FastUtilIntHashMap();
    ...
    public WorldClient(NetHandlerPlayClient p_i45063_1_, WorldSettings p_i45063_2_, int p_i45063_3_, EnumDifficulty p_i45063_4_, Profiler p_i45063_5_) {
        ...
        this.previousActiveChunkSet = new LongChunkCoordIntPairSet();
    ...
    protected void func_147456_g() {
        ...
        int i = 0;
        Set injectorAllocatedLocal7 = this.activeChunkSet;
        Iterator iterator = this.redirect$zzo000$hodgepodge$fixAllocations(injectorAllocatedLocal7);
    ...
    public boolean spawnEntityInWorld(Entity p_72838_1_) {
        ...
        if (!flag) {
            ...
            SoundHandler var10000 = this.mc.getSoundHandler();
            ISound injectorAllocatedLocal4 = new MovingSoundMinecart((EntityMinecart)p_72838_1_);
            SoundHandler injectorAllocatedLocal3 = var10000;
            this.redirect$zfm000$hodgepodge$cancelSound(injectorAllocatedLocal3, injectorAllocatedLocal4);
        }
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldClient_FixAllocations",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private Iterator<ChunkCoordIntPair> redirect$zzo000$hodgepodge$fixAllocations(Set<ChunkCoordIntPair> instance) {
        return ((LongChunkCoordIntPairSet)instance).unsafeIterator();
    }

    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinWorldClient",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private void redirect$zfm000$hodgepodge$cancelSound(SoundHandler soundHandler, ISound isound) {
    }
}
