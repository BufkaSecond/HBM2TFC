...
public class ItemReed extends Item {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
        ...
        block = this.localvar$zci000$hodgepodge$onItemUseWithIsReplaceable(block, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_);
        ...
        if (!p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_)) {
            ...
            if (p_77648_3_.canPlaceEntityOnSide(this.field_150935_a, p_77648_4_, p_77648_5_, p_77648_6_, false, p_77648_7_, (Entity)null, p_77648_1_)) {
                ...
                if (p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, this.field_150935_a, i1, 3)) {
                    Block var10000 = p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_);
                    this.localvar$zci000$hodgepodge$onItemUseWithIsReplaceable(block, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_);
                    if (var10000 == this.field_150935_a) {
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinItemReed",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private Block localvar$zci000$hodgepodge$onItemUseWithIsReplaceable(Block original, World world, int x, int y, int z) {
        return (Block)(original.isReplaceable(world, x, y, z) ? Blocks.tallgrass : original);
    }
}
