...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        if (!this.worldObj.isRemote) {
            if (this.getAggressive()) {
                ...
                if (short1 > -1) {
                    this.setCurrentItemOrArmor(0, new ItemStack(Items.potionitem, 1, this.modify$zcm000$hodgepodge$changeWitchDrinkingPotion(short1)));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        if (!this.getAggressive()) {
            int injectorAllocatedLocal11 = 32732;
            EntityPotion entitypotion = new EntityPotion(this.worldObj, this, this.modify$zcm000$hodgepodge$changeThrownHarmingPotion(injectorAllocatedLocal11));
            ...
            if (f1 >= 8.0F && !p_82196_1_.isPotionActive(Potion.moveSlowdown)) {
                injectorAllocatedLocal11 = 32698;
                entitypotion.setPotionDamage(this.modify$zcm000$hodgepodge$changeThrownPotion(injectorAllocatedLocal11));
            } else if (p_82196_1_.getHealth() >= 8.0F && !p_82196_1_.isPotionActive(Potion.poison)) {
                injectorAllocatedLocal11 = 32660;
                entitypotion.setPotionDamage(this.modify$zcm000$hodgepodge$changeThrownPotion(injectorAllocatedLocal11));
            } else if (f1 <= 3.0F && !p_82196_1_.isPotionActive(Potion.weakness) && this.rand.nextFloat() < 0.25F) {
                injectorAllocatedLocal11 = 32696;
                entitypotion.setPotionDamage(this.modify$zcm000$hodgepodge$changeThrownPotion(injectorAllocatedLocal11));
            }
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinEntityWitch",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    private int modify$zcm000$hodgepodge$changeWitchDrinkingPotion(int meta) {
        int var10000;
        switch(meta) {
        case 8237:
            var10000 = 8205;
    ...
    private int modify$zcm000$hodgepodge$changeThrownHarmingPotion(int meta) {
        return 16396;
    }
    ...
    private int modify$zcm000$hodgepodge$changeThrownPotion(int meta) {
        int var10000;
        switch(meta) {
        case 32660:
            var10000 = 16388;
