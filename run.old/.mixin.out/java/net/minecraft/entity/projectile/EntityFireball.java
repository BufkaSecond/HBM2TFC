...
public abstract class EntityFireball extends Entity {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        this.handler$zch000$hodgepodge$writeFireballAcceleration(tagCompound, (CallbackInfo)null);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.handler$zch000$hodgepodge$readFireballAcceleration(tagCompund, (CallbackInfo)null);
    }
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinEntityFireball",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    public void handler$zch000$hodgepodge$writeFireballAcceleration(NBTTagCompound tagCompound, CallbackInfo ci) {
        tagCompound.setTag("acceleration", this.newDoubleNBTList(new double[]{this.accelerationX, this.accelerationY, this.accelerationZ}));
    }
    ...
    public void handler$zch000$hodgepodge$readFireballAcceleration(NBTTagCompound tagCompund, CallbackInfo ci) {
