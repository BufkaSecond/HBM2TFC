...
public abstract class EntityLiving extends EntityLivingBase {
            ...
            while(true) {
                ...
                do {
                    do {
                        ...
                        } while(entityitem.isDead);
                    } while(entityitem.getEntityItem() == null);

                    itemstack = entityitem.getEntityItem();
                    i = getArmorPosition(itemstack);
                } while(i <= -1);
                ...
                if (flag) {
                    ...
                    boolean var10 = true;
                    this.redirect$zdi000$hodgepodge$dontSetPersistenceRequired(this, var10);
    ...
    protected void despawnEntity() {
        ...
        if (this.persistenceRequired) {
            this.entityAge = 0;
        } else if ((this.entityAge & 31) == 31 && (result = ForgeEventFactory.canEntityDespawn(this)) != Result.DEFAULT) {
            if (result == Result.DENY) {
                this.entityAge = 0;
            } else {
                this.handler$zdi000$hodgepodge$despawnEntity_dropPickedLoot((CallbackInfo)null);
                this.setDead();
            }
        } else {
    ...
    public void setAlwaysRenderNameTag(boolean p_94061_1_) {
        this.dataWatcher.updateObject(11, (byte)(p_94061_1_ ? 1 : 0));
    }
    ...
    @Overwrite
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinEntityLivingPickup",
        priority = 1000,
    ...
    @MixinMerged(
        mixin = "com.mitchej123.hodgepodge.mixins.early.minecraft.MixinEntityLivingDrop",
        priority = 1000,
        sessionId = "98d213e4-85ca-4ce4-959f-84858add440a"
    )
    public void redirect$zdi000$hodgepodge$dontSetPersistenceRequired(EntityLiving o, boolean newVal) {
    }
    ...
    public void handler$zdi000$hodgepodge$despawnEntity_dropPickedLoot(CallbackInfo ci) {
